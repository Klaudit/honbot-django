...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerStats', fields ['mmr']
        db.create_index(u'honbot_playerstats', ['mmr'])

        # Adding index on 'PlayerStats', fields ['nickname']
        db.create_index(u'honbot_playerstats', ['nickname'])


    def backwards(self, orm):
        # Removing index on 'PlayerStats', fields ['nickname']
        db.delete_index(u'honbot_playerstats', ['nickname'])

        # Removing index on 'PlayerStats', fields ['mmr']
        db.delete_index(u'honbot_playerstats', ['mmr'])
