...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerHistory', fields ['mode']
        db.create_index(u'honbot_playerhistory', ['mode'])

        # Adding index on 'Matches', fields ['mode']
        db.create_index(u'honbot_matches', ['mode'])


    def backwards(self, orm):
        # Removing index on 'Matches', fields ['mode']
        db.delete_index(u'honbot_matches', ['mode'])

        # Removing index on 'PlayerHistory', fields ['mode']
        db.delete_index(u'honbot_playerhistory', ['mode'])
