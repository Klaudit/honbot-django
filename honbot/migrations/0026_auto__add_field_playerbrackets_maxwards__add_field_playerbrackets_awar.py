...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerBrackets.maxwards'
        db.add_column(u'honbot_playerbrackets', 'maxwards',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.awards'
        db.add_column(u'honbot_playerbrackets', 'awards',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.minwards'
        db.add_column(u'honbot_playerbrackets', 'minwards',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerBrackets.maxwards'
        db.delete_column(u'honbot_playerbrackets', 'maxwards')

        # Deleting field 'PlayerBrackets.awards'
        db.delete_column(u'honbot_playerbrackets', 'awards')

        # Deleting field 'PlayerBrackets.minwards'
        db.delete_column(u'honbot_playerbrackets', 'minwards')
