...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeroUseage.popularity'
        db.add_column(u'honbot_herouseage', 'popularity',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeroUseage.popularity'
        db.delete_column(u'honbot_herouseage', 'popularity')
