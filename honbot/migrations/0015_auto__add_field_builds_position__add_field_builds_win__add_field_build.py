...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Builds.position'
        db.add_column(u'honbot_builds', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Builds.win'
        db.add_column(u'honbot_builds', 'win',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Builds.mmr'
        db.add_column(u'honbot_builds', 'mmr',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Builds.position'
        db.delete_column(u'honbot_builds', 'position')

        # Deleting field 'Builds.win'
        db.delete_column(u'honbot_builds', 'win')

        # Deleting field 'Builds.mmr'
        db.delete_column(u'honbot_builds', 'mmr')
