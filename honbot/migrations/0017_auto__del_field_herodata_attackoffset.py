...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeroData.attackoffset'
        db.delete_column(u'honbot_herodata', 'attackoffset')


    def backwards(self, orm):
        # Adding field 'HeroData.attackoffset'
        db.add_column(u'honbot_herodata', 'attackoffset',
