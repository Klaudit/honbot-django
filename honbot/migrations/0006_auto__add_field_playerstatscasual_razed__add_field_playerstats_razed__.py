...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerStatsCasual.razed'
        db.add_column(u'honbot_playerstatscasual', 'razed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.razed'
        db.add_column(u'honbot_playerstats', 'razed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStatsPublic.razed'
        db.add_column(u'honbot_playerstatspublic', 'razed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerStatsCasual.razed'
        db.delete_column(u'honbot_playerstatscasual', 'razed')

        # Deleting field 'PlayerStats.razed'
        db.delete_column(u'honbot_playerstats', 'razed')

        # Deleting field 'PlayerStatsPublic.razed'
        db.delete_column(u'honbot_playerstatspublic', 'razed')
