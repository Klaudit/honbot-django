...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerMatches.herodmg'
        db.alter_column(u'honbot_playermatches', 'herodmg', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'PlayerMatches.herodmg'
        db.alter_column(u'honbot_playermatches', 'herodmg', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
