...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerStats.ks10'
        db.alter_column(u'honbot_playerstats', 'ks10', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'PlayerStats.ks15'
        db.alter_column(u'honbot_playerstats', 'ks15', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'PlayerStats.ks9'
        db.alter_column(u'honbot_playerstats', 'ks9', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'PlayerStats.ks10'
        db.alter_column(u'honbot_playerstats', 'ks10', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'PlayerStats.ks15'
        db.alter_column(u'honbot_playerstats', 'ks15', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'PlayerStats.ks9'
        db.alter_column(u'honbot_playerstats', 'ks9', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
