...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matches._map'
        db.alter_column(u'honbot_matches', '_map', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Matches._map'
        db.alter_column(u'honbot_matches', '_map', self.gf('django.db.models.fields.CharField')(max_length=10))
