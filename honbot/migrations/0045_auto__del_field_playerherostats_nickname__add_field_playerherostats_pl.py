...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayerHeroStats.nickname'
        db.delete_column(u'honbot_playerherostats', 'nickname')

        # Adding field 'PlayerHeroStats.player_id'
        db.add_column(u'honbot_playerherostats', 'player_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PlayerHeroStats.nickname'
        db.add_column(u'honbot_playerherostats', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'PlayerHeroStats.player_id'
        db.delete_column(u'honbot_playerherostats', 'player_id')
    ...
    models = {
        ...
        u'honbot.items': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'description_simple': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'effect_header': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'icon': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'impact_effect': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            ...
            'search_terms': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'shop_categories': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'shop_flavor': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'usedin': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'})
        },
