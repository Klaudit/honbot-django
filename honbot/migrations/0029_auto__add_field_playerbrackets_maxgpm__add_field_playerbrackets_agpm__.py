...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerBrackets.maxgpm'
        db.add_column(u'honbot_playerbrackets', 'maxgpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.agpm'
        db.add_column(u'honbot_playerbrackets', 'agpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.mingpm'
        db.add_column(u'honbot_playerbrackets', 'mingpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdgpm'
        db.add_column(u'honbot_playerbrackets', 'stdgpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerBrackets.maxgpm'
        db.delete_column(u'honbot_playerbrackets', 'maxgpm')

        # Deleting field 'PlayerBrackets.agpm'
        db.delete_column(u'honbot_playerbrackets', 'agpm')

        # Deleting field 'PlayerBrackets.mingpm'
        db.delete_column(u'honbot_playerbrackets', 'mingpm')

        # Deleting field 'PlayerBrackets.stdgpm'
        db.delete_column(u'honbot_playerbrackets', 'stdgpm')
