...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.shop_categories'
        db.alter_column(u'honbot_items', 'shop_categories', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Items.shop_flavor'
        db.alter_column(u'honbot_items', 'shop_flavor', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Items.shop_categories'
        db.alter_column(u'honbot_items', 'shop_categories', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Items.shop_flavor'
        db.alter_column(u'honbot_items', 'shop_flavor', self.gf('django.db.models.fields.TextField')())
