...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Items'
        db.create_table(u'honbot_items', (
            ('item_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True, primary_key=True)),
            ...
            ('ispassive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('recipecost', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('usedin', self.gf('django.db.models.fields.TextField')(default='')),
            ('description_simple', self.gf('django.db.models.fields.TextField')(default='')),
            ('effect_header', self.gf('django.db.models.fields.TextField')(default='')),
            ('search_terms', self.gf('django.db.models.fields.TextField')(default='')),
            ('shop_categories', self.gf('django.db.models.fields.TextField')(default='')),
            ('shop_flavor', self.gf('django.db.models.fields.TextField')(default='')),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'honbot', ['Items'])


    def backwards(self, orm):
        # Deleting model 'Items'
        db.delete_table(u'honbot_items')
    ...
    models = {
        ...
        u'honbot.items': {
            ...
            'description_simple': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'effect_header': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'icon': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'ispassive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'item_id': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'recipecost': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'search_terms': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'shop_categories': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'shop_flavor': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'usedin': ('django.db.models.fields.TextField', [], {'default': "''"})
        },
