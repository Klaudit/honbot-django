...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerIcon', fields ['player_id']
        db.create_index(u'honbot_playericon', ['player_id'])


    def backwards(self, orm):
        # Removing index on 'PlayerIcon', fields ['player_id']
        db.delete_index(u'honbot_playericon', ['player_id'])
