...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HeroUse.date'
        db.alter_column(u'honbot_herouse', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'HeroUse.date'
        db.alter_column(u'honbot_herouse', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
