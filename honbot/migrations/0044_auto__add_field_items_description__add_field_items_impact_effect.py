...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Items.description'
        db.add_column(u'honbot_items', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)

        # Adding field 'Items.impact_effect'
        db.add_column(u'honbot_items', 'impact_effect',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Items.description'
        db.delete_column(u'honbot_items', 'description')

        # Deleting field 'Items.impact_effect'
        db.delete_column(u'honbot_items', 'impact_effect')
