...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerBrackets'
        db.create_table(u'honbot_playerbrackets', (
            ('mmr_bracket', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, primary_key=True)),
            ...
            ('atime', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('aactionsmin', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        db.send_create_signal(u'honbot', ['PlayerBrackets'])


    def backwards(self, orm):
        # Deleting model 'PlayerBrackets'
        db.delete_table(u'honbot_playerbrackets')
