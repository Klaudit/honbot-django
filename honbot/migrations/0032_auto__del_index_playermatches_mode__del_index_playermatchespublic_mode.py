...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'PlayerMatches', fields ['mode']
        db.delete_index(u'honbot_playermatches', ['mode'])

        # Removing index on 'PlayerMatchesPublic', fields ['mode']
        db.delete_index(u'honbot_playermatchespublic', ['mode'])

        # Removing index on 'PlayerMatchesCasual', fields ['mode']
        db.delete_index(u'honbot_playermatchescasual', ['mode'])


    def backwards(self, orm):
        # Adding index on 'PlayerMatchesCasual', fields ['mode']
        db.create_index(u'honbot_playermatchescasual', ['mode'])

        # Adding index on 'PlayerMatchesPublic', fields ['mode']
        db.create_index(u'honbot_playermatchespublic', ['mode'])

        # Adding index on 'PlayerMatches', fields ['mode']
        db.create_index(u'honbot_playermatches', ['mode'])
