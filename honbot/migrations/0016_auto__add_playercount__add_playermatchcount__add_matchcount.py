...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'honbot_playercount', (
            ('date', self.gf('django.db.models.fields.DateField')(unique=True, primary_key=True, db_index=True)),
    ...
    models = {
        ...
        u'honbot.matchcount': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'unique': 'True', 'primary_key': 'True', 'db_index': 'True'})
        },
        u'honbot.matches': {
