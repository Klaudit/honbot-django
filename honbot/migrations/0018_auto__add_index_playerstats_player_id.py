...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerStats', fields ['player_id']
        db.create_index(u'honbot_playerstats', ['player_id'])


    def backwards(self, orm):
        # Removing index on 'PlayerStats', fields ['player_id']
        db.delete_index(u'honbot_playerstats', ['player_id'])
