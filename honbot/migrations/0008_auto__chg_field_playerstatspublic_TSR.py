...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerStatsPublic.TSR'
        db.alter_column(u'honbot_playerstatspublic', 'TSR', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'PlayerStatsPublic.TSR'
        db.alter_column(u'honbot_playerstatspublic', 'TSR', self.gf('django.db.models.fields.FloatField')())
