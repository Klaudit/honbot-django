...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerMatches', fields ['date']
        db.create_index(u'honbot_playermatches', ['date'])


    def backwards(self, orm):
        # Removing index on 'PlayerMatches', fields ['date']
        db.delete_index(u'honbot_playermatches', ['date'])
