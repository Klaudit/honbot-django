...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Matches', fields ['match_id']
        db.create_index(u'honbot_matches', ['match_id'])


    def backwards(self, orm):
        # Removing index on 'Matches', fields ['match_id']
        db.delete_index(u'honbot_matches', ['match_id'])
