...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeroData.rangerating'
        db.delete_column(u'honbot_herodata', 'rangerating')

        # Adding field 'HeroData.rangedrating'
        db.add_column(u'honbot_herodata', 'rangedrating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HeroData.rangerating'
        db.add_column(u'honbot_herodata', 'rangerating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'HeroData.rangedrating'
        db.delete_column(u'honbot_herodata', 'rangedrating')
