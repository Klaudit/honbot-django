...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming model 'HeroUseage' to 'herouse'
        db.rename_table('honbot_herouseage', 'honbot_herouse')
        db.send_create_signal(u'honbot', ['HeroUse'])


    def backwards(self, orm):
        # Adding model 'HeroUseage'
        db.create_table(u'honbot_herouseage', (
            ('popularity', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('usage', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True, db_index=True)),
        ...
        # Deleting model 'HeroUse'
        db.delete_table(u'honbot_herouse')
