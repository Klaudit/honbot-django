...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeroData.pushrating'
        db.delete_column(u'honbot_herodata', 'pushrating')

        # Adding field 'HeroData.pusherrating'
        db.add_column(u'honbot_herodata', 'pusherrating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HeroData.pushrating'
        db.add_column(u'honbot_herodata', 'pushrating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'HeroData.pusherrating'
        db.delete_column(u'honbot_herodata', 'pusherrating')
