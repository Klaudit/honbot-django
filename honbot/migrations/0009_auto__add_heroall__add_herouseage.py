...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HeroAll'
        db.create_table(u'honbot_heroall', (
            ...
            ('team', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'honbot', ['HeroAll'])

        # Adding model 'HeroUseage'
        db.create_table(u'honbot_herouseage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, db_index=True, blank=True)),
            ('hero_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('usage', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'honbot', ['HeroUseage'])


    def backwards(self, orm):
        # Deleting model 'HeroAll'
        db.delete_table(u'honbot_heroall')

        # Deleting model 'HeroUseage'
        db.delete_table(u'honbot_herouseage')
