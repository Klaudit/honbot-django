...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matches.replay_url'
        db.alter_column(u'honbot_matches', 'replay_url', self.gf('django.db.models.fields.URLField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'Matches.replay_url'
        db.alter_column(u'honbot_matches', 'replay_url', self.gf('django.db.models.fields.URLField')(max_length=120))
