...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.search_terms'
        db.alter_column(u'honbot_items', 'search_terms', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Items.search_terms'
        db.alter_column(u'honbot_items', 'search_terms', self.gf('django.db.models.fields.TextField')())
