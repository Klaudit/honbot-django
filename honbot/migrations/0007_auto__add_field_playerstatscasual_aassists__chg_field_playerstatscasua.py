...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerStatsCasual.aassists'
        db.add_column(u'honbot_playerstatscasual', 'aassists',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'PlayerStatsCasual.assists'
        db.alter_column(u'honbot_playerstatscasual', 'assists', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding field 'PlayerStats.aassists'
        db.add_column(u'honbot_playerstats', 'aassists',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'PlayerStats.assists'
        db.alter_column(u'honbot_playerstats', 'assists', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding field 'PlayerStatsPublic.aassists'
        db.add_column(u'honbot_playerstatspublic', 'aassists',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'PlayerStatsPublic.assists'
        db.alter_column(u'honbot_playerstatspublic', 'assists', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'PlayerStatsCasual.aassists'
        db.delete_column(u'honbot_playerstatscasual', 'aassists')


        # Changing field 'PlayerStatsCasual.assists'
        db.alter_column(u'honbot_playerstatscasual', 'assists', self.gf('django.db.models.fields.FloatField')())
        # Deleting field 'PlayerStats.aassists'
        db.delete_column(u'honbot_playerstats', 'aassists')


        # Changing field 'PlayerStats.assists'
        db.alter_column(u'honbot_playerstats', 'assists', self.gf('django.db.models.fields.FloatField')())
        # Deleting field 'PlayerStatsPublic.aassists'
        db.delete_column(u'honbot_playerstatspublic', 'aassists')


        # Changing field 'PlayerStatsPublic.assists'
        db.alter_column(u'honbot_playerstatspublic', 'assists', self.gf('django.db.models.fields.FloatField')())
