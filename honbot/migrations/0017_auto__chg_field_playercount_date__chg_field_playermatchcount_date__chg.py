...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerCount.date'
        db.alter_column(u'honbot_playercount', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, unique=True, primary_key=True))

        # Changing field 'PlayerMatchCount.date'
        db.alter_column(u'honbot_playermatchcount', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, unique=True, primary_key=True))

        # Changing field 'MatchCount.date'
        db.alter_column(u'honbot_matchcount', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, unique=True, primary_key=True))

    def backwards(self, orm):

        # Changing field 'PlayerCount.date'
        db.alter_column(u'honbot_playercount', 'date', self.gf('django.db.models.fields.DateField')(unique=True, primary_key=True))

        # Changing field 'PlayerMatchCount.date'
        db.alter_column(u'honbot_playermatchcount', 'date', self.gf('django.db.models.fields.DateField')(unique=True, primary_key=True))

        # Changing field 'MatchCount.date'
        db.alter_column(u'honbot_matchcount', 'date', self.gf('django.db.models.fields.DateField')(unique=True, primary_key=True))
