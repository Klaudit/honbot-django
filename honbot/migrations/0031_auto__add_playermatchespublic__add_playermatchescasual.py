...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerMatchesPublic'
        db.create_table(u'honbot_playermatchespublic', (
            ...
            ('mode', self.gf('django.db.models.fields.CharField')(default='', max_length=10, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'honbot', ['PlayerMatchesPublic'])

        # Adding model 'PlayerMatchesCasual'
        db.create_table(u'honbot_playermatchescasual', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True)),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['honbot.Matches'])),
            ('deaths', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ...
        db.send_create_signal(u'honbot', ['PlayerMatchesCasual'])


    def backwards(self, orm):
        # Deleting model 'PlayerMatchesPublic'
        db.delete_table(u'honbot_playermatchespublic')

        # Deleting model 'PlayerMatchesCasual'
        db.delete_table(u'honbot_playermatchescasual')
