...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeroData.melerating'
        db.delete_column(u'honbot_herodata', 'melerating')

        # Adding field 'HeroData.meleerating'
        db.add_column(u'honbot_herodata', 'meleerating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HeroData.melerating'
        db.add_column(u'honbot_herodata', 'melerating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'HeroData.meleerating'
        db.delete_column(u'honbot_herodata', 'meleerating')
