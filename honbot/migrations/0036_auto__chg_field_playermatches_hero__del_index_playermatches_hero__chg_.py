...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PlayerMatches.hero' to match new field type.
        db.rename_column(u'honbot_playermatches', 'hero_id', 'hero')
        # Changing field 'PlayerMatches.hero'
        db.alter_column(u'honbot_playermatches', 'hero', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Removing index on 'PlayerMatches', fields ['hero']
        db.delete_index(u'honbot_playermatches', ['hero_id'])


        # Renaming column for 'PlayerMatchesPublic.hero' to match new field type.
        db.rename_column(u'honbot_playermatchespublic', 'hero_id', 'hero')
        # Changing field 'PlayerMatchesPublic.hero'
        db.alter_column(u'honbot_playermatchespublic', 'hero', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Removing index on 'PlayerMatchesPublic', fields ['hero']
        db.delete_index(u'honbot_playermatchespublic', ['hero_id'])


        # Renaming column for 'PlayerMatchesCasual.hero' to match new field type.
        db.rename_column(u'honbot_playermatchescasual', 'hero_id', 'hero')
        # Changing field 'PlayerMatchesCasual.hero'
        db.alter_column(u'honbot_playermatchescasual', 'hero', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Removing index on 'PlayerMatchesCasual', fields ['hero']
        db.delete_index(u'honbot_playermatchescasual', ['hero_id'])


    def backwards(self, orm):
        # Adding index on 'PlayerMatchesCasual', fields ['hero']
        db.create_index(u'honbot_playermatchescasual', ['hero_id'])

        # Adding index on 'PlayerMatchesPublic', fields ['hero']
        db.create_index(u'honbot_playermatchespublic', ['hero_id'])

        # Adding index on 'PlayerMatches', fields ['hero']
        db.create_index(u'honbot_playermatches', ['hero_id'])


        # Renaming column for 'PlayerMatches.hero' to match new field type.
        db.rename_column(u'honbot_playermatches', 'hero', 'hero_id')
        # Changing field 'PlayerMatches.hero'
        db.alter_column(u'honbot_playermatches', 'hero_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['honbot.HeroData']))

        # Renaming column for 'PlayerMatchesPublic.hero' to match new field type.
        db.rename_column(u'honbot_playermatchespublic', 'hero', 'hero_id')
        # Changing field 'PlayerMatchesPublic.hero'
        db.alter_column(u'honbot_playermatchespublic', 'hero_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['honbot.HeroData']))

        # Renaming column for 'PlayerMatchesCasual.hero' to match new field type.
        db.rename_column(u'honbot_playermatchescasual', 'hero', 'hero_id')
        # Changing field 'PlayerMatchesCasual.hero'
        db.alter_column(u'honbot_playermatchescasual', 'hero_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['honbot.HeroData']))
    ...
    models = {
        ...
        u'honbot.playermatchescasual': {
            'Meta': {'object_name': 'PlayerMatchesCasual'},
            'annihilation': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'apm': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'assists': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'bdmg': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
        ...
        u'honbot.playermatchespublic': {
            'Meta': {'object_name': 'PlayerMatchesPublic'},
            'annihilation': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'apm': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'assists': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'bdmg': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
