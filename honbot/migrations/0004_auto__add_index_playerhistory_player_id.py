...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlayerHistory', fields ['player_id']
        db.create_index(u'honbot_playerhistory', ['player_id'])


    def backwards(self, orm):
        # Removing index on 'PlayerHistory', fields ['player_id']
        db.delete_index(u'honbot_playerhistory', ['player_id'])
