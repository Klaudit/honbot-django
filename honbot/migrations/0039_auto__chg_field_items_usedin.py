...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.usedin'
        db.alter_column(u'honbot_items', 'usedin', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Items.usedin'
        db.alter_column(u'honbot_items', 'usedin', self.gf('django.db.models.fields.TextField')())
