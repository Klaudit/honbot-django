...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerBrackets.maxxpm'
        db.add_column(u'honbot_playerbrackets', 'maxxpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.axpm'
        db.add_column(u'honbot_playerbrackets', 'axpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.minxpm'
        db.add_column(u'honbot_playerbrackets', 'minxpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdxpm'
        db.add_column(u'honbot_playerbrackets', 'stdxpm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerBrackets.maxxpm'
        db.delete_column(u'honbot_playerbrackets', 'maxxpm')

        # Deleting field 'PlayerBrackets.axpm'
        db.delete_column(u'honbot_playerbrackets', 'axpm')

        # Deleting field 'PlayerBrackets.minxpm'
        db.delete_column(u'honbot_playerbrackets', 'minxpm')

        # Deleting field 'PlayerBrackets.stdxpm'
        db.delete_column(u'honbot_playerbrackets', 'stdxpm')
