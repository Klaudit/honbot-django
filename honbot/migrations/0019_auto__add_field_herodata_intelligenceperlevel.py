...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeroData.intelligenceperlevel'
        db.add_column(u'honbot_herodata', 'intelligenceperlevel',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeroData.intelligenceperlevel'
        db.delete_column(u'honbot_herodata', 'intelligenceperlevel')
