...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerBrackets.stdkills'
        db.add_column(u'honbot_playerbrackets', 'stdkills',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdassists'
        db.add_column(u'honbot_playerbrackets', 'stdassists',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stddeaths'
        db.add_column(u'honbot_playerbrackets', 'stddeaths',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdactionsmin'
        db.add_column(u'honbot_playerbrackets', 'stdactionsmin',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdcs'
        db.add_column(u'honbot_playerbrackets', 'stdcs',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stddenies'
        db.add_column(u'honbot_playerbrackets', 'stddenies',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerBrackets.stdwards'
        db.add_column(u'honbot_playerbrackets', 'stdwards',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerBrackets.stdkills'
        db.delete_column(u'honbot_playerbrackets', 'stdkills')

        # Deleting field 'PlayerBrackets.stdassists'
        db.delete_column(u'honbot_playerbrackets', 'stdassists')

        # Deleting field 'PlayerBrackets.stddeaths'
        db.delete_column(u'honbot_playerbrackets', 'stddeaths')

        # Deleting field 'PlayerBrackets.stdactionsmin'
        db.delete_column(u'honbot_playerbrackets', 'stdactionsmin')

        # Deleting field 'PlayerBrackets.stdcs'
        db.delete_column(u'honbot_playerbrackets', 'stdcs')

        # Deleting field 'PlayerBrackets.stddenies'
        db.delete_column(u'honbot_playerbrackets', 'stddenies')

        # Deleting field 'PlayerBrackets.stdwards'
        db.delete_column(u'honbot_playerbrackets', 'stdwards')
